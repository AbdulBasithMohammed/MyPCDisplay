...
if __name__ == "__main__":
    ...
    try:
        ...
        if os.environ.get("DECK_CHILD") == "1":
            # LOCAL MODIFICATION: deck.py supervises this process and owns the
            # tray icon. Showing a second icon would just confuse the user.
            tray_icon = None
            logger.info("DECK_CHILD=1: tray icon suppressed (supervisor owns it)")
